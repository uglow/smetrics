...
Command | Description
:------ | :----------
<pre>npm run verify</pre> | Verify code style without fixing errors
<pre>npm run lint</pre> | Verify code style and fix any errors that can be fixed automatically
